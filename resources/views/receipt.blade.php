...
<body>
  <div class="container">
    ...
    <?php
    // Access session data using Laravel helpers
    ...
    <p><strong>Name:</strong> {{ session('personalDetails.firstName') }} {{ session('personalDetails.lastName') }}</p>
    <p><strong>Email:</strong> {{ session('personalDetails.email') }}</p>
