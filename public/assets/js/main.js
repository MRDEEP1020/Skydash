...
const inputElements = searchContainer.querySelectorAll('.search-input-group input');
...
window.addEventListener('scroll', function () {
  ...
  if (scrollY > navbarHeight) { // Adjusted condition for better positioning
      ...
      document.querySelectorAll('.flight-card').forEach(function(card) {
          ...
          if (filter === 'best') {
              ...
              if (price === bestPrice) {
                  ...
                  if (priceCard) {
                      priceCard.style.display = 'flex'; // Show corresponding price card
                  }
              } else {
                  card.style.display = 'none';
                  if (priceCard) {
                      priceCard.style.display = 'none'; // Hide corresponding price card
                  }
              }
